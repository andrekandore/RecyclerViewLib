...
/**
 * A {@link com.twotoasters.android.support.v7.widget.RecyclerView.LayoutManager} implementation which provides
...
public class LinearLayoutManager extends RecyclerView.LayoutManager {
     ...
     * helps {@link com.twotoasters.android.support.v7.widget.LinearLayoutManager} make those decisions.
     ...
     * {@link #onLayoutChildren(com.twotoasters.android.support.v7.widget.RecyclerView.Recycler, com.twotoasters.android.support.v7.widget.RecyclerView.State)} is run.
     */
    ...
    /**
     * Sets the orientation of the layout. {@link com.twotoasters.android.support.v7.widget.LinearLayoutManager}
     ...
     * When set to true, If {@link com.twotoasters.android.support.v7.widget.RecyclerView} is LTR, than it will
     * render from RTL, if {@link com.twotoasters.android.support.v7.widget.RecyclerView}} is RTL, it will render
     * from LTR.
     *
     ...
     * By default, {@link com.twotoasters.android.support.v7.widget.LinearLayoutManager} lays out 1 extra page of
     ...
     *
     * @param recycler Recycler instance of {@link com.twotoasters.android.support.v7.widget.RecyclerView}
     ...
     * @see #recycleViewsFromStart(com.twotoasters.android.support.v7.widget.RecyclerView.Recycler, int)
     * @see #recycleViewsFromEnd(com.twotoasters.android.support.v7.widget.RecyclerView.Recycler, int)
     * @see com.twotoasters.android.support.v7.widget.LinearLayoutManager.RenderState#mLayoutDirection
     */
     ...
     * independent from the rest of the {@link com.twotoasters.android.support.v7.widget.LinearLayoutManager}
     ...
     *
     * @return The adapter position of the first visible item or {@link com.twotoasters.android.support.v7.widget.RecyclerView#NO_POSITION} if
     ...
     * {@link com.twotoasters.android.support.v7.widget.RecyclerView#NO_POSITION} if there aren't any visible items.
     ...
     * are ignored in this method.
     *
     * @return The adapter position of the last visible view or {@link com.twotoasters.android.support.v7.widget.RecyclerView#NO_POSITION} if
     * there aren't any visible items.
     * @see #findLastCompletelyVisibleItemPosition()
     * @see #findFirstVisibleItemPosition()
     */
